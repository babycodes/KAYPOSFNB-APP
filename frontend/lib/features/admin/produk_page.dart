...
class _RecipeModalState extends State<RecipeModal> {
  ...
  Widget build(BuildContext context) {
    ...
    for (var ing in _ingredients) {
      ...
      // Normalize: if master unit is Kg/Liter, cost_price is per Kg/Liter
      // but qty_needed is in gram/ml, so cost per base = cost / 1000
    ...
    if (_selectedBahanId != null) {
      try {
        ...
        // Recipe input uses base unit for human-readable entry
              ...
              : _ingredients.isEmpty 
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, i) {
                      ...
                      // Display in recipe base unit (gram/ml) with normalized cost
